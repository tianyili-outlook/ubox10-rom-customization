...
| 当前实验候选 | `out/candidates/test9r2-android-tv-remote-service-rro-path-r1/x12-test9r2-android-tv-remote-service-rro-path.img` | `27B54FB83E96D3863FAE2EF2718E8EC9ADDD863E5ED123082D5E6C8CA6FFFD52` |
...
- 所有淘汰候选目录及其固件和中间分区。
- Test8r2/当前候选目录内除最终 PhoenixCard 固件外的 `system_a/super/vendor/product/vbmeta` 等中间 `.img`。
