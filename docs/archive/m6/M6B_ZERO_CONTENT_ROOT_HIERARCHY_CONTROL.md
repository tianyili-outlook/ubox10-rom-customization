# [归档] M6b.0：零内容 `system` root-hierarchy control 设计
...
- 前置发现：D-0036、D-0037 与 D-0038（原历史编号；现行结论见 [发现汇总](../../DISCOVERIES.md)）。
...
该决策也由 ADR-0009（原历史编号；现行原则见 [决策记录](../../DECISIONS.md)）固化。
