...
- 当前设备验收基线：`m8b-audio-r2`，状态为 **DEVICE ACCEPTED / AUDIO PASS**。Projectivy、native rc-core 遥控、Wi-Fi、Ethernet、Bluetooth/HID、USB host/storage、H.264/HEVC 硬解与 HDMI 音频均已通过。
